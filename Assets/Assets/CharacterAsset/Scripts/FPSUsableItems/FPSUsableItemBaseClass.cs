...
public abstract class FPSUsableItemBaseClass : MonoBehaviour
{
    ...
    private FPSUsableItemManager _manager;
    ...
    {
        if (_manager == null) { _manager = GetComponent<FPSUsableItemManager>(); }
