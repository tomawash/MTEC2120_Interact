...
public class USABLEITEM_FPS_Blaster : FPSUsableItemBaseClass
{
    ...
    FPSUsableItemManager FPSUsableItemManager;
    ...
    private void Reset()
    {
        ...
        launchedBullet = sResourceGrabbingFunctions.getPrefabFromResourcesByName("ExampleProjectile"); 
    }
    ...
    public void OnEnable()
    {
        ...
        FPSUsableItemManager = GetComponent<FPSUsableItemManager>();
        referenceToBlasterTransform = FPSUsableItemManager.activeItemPrefab.transform;
        gunAnimator = referenceToBlasterTransform.GetComponentInChildren<Animator>();
        bulletSpawnPos = GameObject.Find("FPSGunFireLocation").transform;
        camMoveScript = GameObject.Find("AbilityManager").GetComponent<ABILITY_CameraMovement>();
    }
