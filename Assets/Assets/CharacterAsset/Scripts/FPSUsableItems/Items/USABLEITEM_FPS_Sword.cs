...
public class USABLEITEM_FPS_Sword : FPSUsableItemBaseClass
{
    ...
    public void OnEnable()
    {
        ...
        referenceToSwordTransform = FPSUsableItemManager.activeItemPrefab.transform;
    ...
    IEnumerator addForceMidSwing()
    {
        ...
        {
            CharacterController charController = CharacterMainController.Instance.GetComponent<CharacterController>();
