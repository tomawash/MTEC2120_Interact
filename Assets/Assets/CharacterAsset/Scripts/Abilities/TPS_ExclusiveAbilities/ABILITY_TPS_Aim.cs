...
[AbilityUsage(CharacterMainController.GameplayTypeFlags.ThirdPerson)]
public class ABILITY_TPS_Aim : AbilityBaseClass
{
    ...
    public void Reset()
    {
        GameObject aimCam = sResourceGrabbingFunctions.addPrefabFromAssetsByName("StarterAssetsThirdPersonAimCamera", GameObject.FindGameObjectWithTag("Player").transform.parent);
        aimVirtualCamera = aimCam.GetComponent<CinemachineVirtualCamera>();
        aimCam.AddComponent<CharacterAssetCamera>();
    }
