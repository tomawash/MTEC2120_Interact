...
[AbilityUsage(CharacterMainController.GameplayTypeFlags.FirstPerson)]
public class ABILITY_FPS_Crouch : AbilityBaseClass
{
    ...
    public override void abilityStart()
    {
        ...
        playerFollowCam = GameObject.Find("StarterAssetsFollowCamera");
    }
