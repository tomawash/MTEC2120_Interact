...
public class PlayerCharacterController : MonoBehaviour {
    ...
    private void HandleCharacterMovement() {
        ...
        if (characterController.isGrounded) {
            ...
            characterVelocityMomentum.y = 0f;
            // Jump
            if (TestInputJump()) {
                float jumpSpeed = 30f;
    ...
    public void SetCharacterVelocityMomentum(Vector3 characterVelocityMomentum) {
        this.characterVelocityMomentum = characterVelocityMomentum;
    }
}
