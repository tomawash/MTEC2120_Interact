...
public class StarterAssetSetup : AssetPostprocessor
{
    ...
    public static void addTag(string tagName)
    {
        ...
        if (!found)
        {
            ...
            n.stringValue = s;
            Debug.Log("Tag:" + tagName + " added by StarterAssetSetup.cs");
        }
    ...
    public static void addLayer(string layerName)
    {
        ...
        if (amountOfLayers >= 32)
        {
            Debug.LogError("Cannot add additional layer " + layerName + " because max layers are reached. " +
                "'s Starter assets needs the additional layer " + layerName + " in order for some features to function.");
            return;
        }
        // if not found, add it
        if (!found)
        {
            ...
            n.stringValue = s;
            Debug.Log("Layer:" + layerName + " added by StarterAssetSetup.cs");
        }
